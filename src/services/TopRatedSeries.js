...
const FilmesApi = axios.create({
    baseURL: "https://api.themoviedb.org/3/tv/top_rated?api_key=3ec3b78e7bcb7df233c8d24e81fd8592&language=pt-BR&page=1"
})
    ...
    render() {
        return (
            <div>
                <S.GlobalStyle />
                <S.Introducao>
                    <S.Principal>Series Mais Votadas</S.Principal>
                    <S.Paragrafo>A seguir um top 20 das Series mais Votadas atualmente</S.Paragrafo>
